...
基于 Python + Tauri 的光学智能仿真与教学辅助平台，集成四个经典波动光学实验的交互式仿真、数据处理和 AI 助教功能。

## 实验项目

| 实验 | 模块状态 |
|------|---------|
| 牛顿环   | 完整：多配置仿真演示 + 数据处理 + PDF 手册 + AI 助教 |
| 双缝干涉 | 完整：交互实验 + PDF 手册/结果分析 + AI 助教 |
| 单缝衍射 | 完整：交互实验 + PDF 手册/结果分析 + AI 助教 |
| 双缝衍射 | 完整：交互实验 + PDF 手册/结果分析 + AI 助教 |
